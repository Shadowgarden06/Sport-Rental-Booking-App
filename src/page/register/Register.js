        ...
        return (
            <div>
                ...
                <Header
                    ...
                    setShowAvatar={setShowAvatar}
                />
                <h1 className='fw-bolder text-center text-uppercase mt-3 mg-3'>
                ...
                <form class='row g-3'>
                    <label htmlFor='inputEmail4' class='form-label address'>
                        Name:
                    </label>
                    ...
                    <div class='col-md-5 address '>
                        <label htmlFor='inputPostal/Zipcode' class='form-label '>
                            Postal / Zipcode
                        </label>
                    ...
                    <div class='row-md-5'>
                        <label for='inputEmail' class='col-sm-2 col-form-label address'>
                            Email:
                        </label>
                        <div class='col-sm-10'>
                            <input
                    ...
                    <div class='row-md-5'>
                        <label for='inputNumber' class='col-sm-2 col-form-label address'>
                            Number:
                        </label>
                        <div class='col-sm-10'>
                            <input
                    ...
                    <div class='row-md-5'>
                        <label for='inputDate' class='col-sm-2 col-form-label address'>
                            Signing Date::
                        </label>
                        <div class='col-sm-10'>
                            <input
                    ...
                    <button type='submit' className='submit' onClick={(e) => onSubmit(e)}>
