    ...
    return (
        <div className='parallax-content'>
            ...
            <div className='d-flex justify-content-around mt-5'>
                <div>
                    <div className='ps-3'>
                        <span className='d-block fs-6 text-uppercase text-start'>Trainings</span>
                ...
                <div>
                    <span className='d-block fs-6 text-uppercase text-start'>From the clubs</span>
                    <span className='fs-1 text-uppercase text-start d-block'>
                    ...
                    <div className='d-flex w-schedule2'>
                        ...
                        <div className='p-3 rounded-top-2'>
                            ...
                            <div className='bg-white p-3 rounded-bottom-2'>
                                ...
                                <div className='fs-13 text-start'>
                                    Discerning the various types seems difficult to the untrained
                                    eye with the divers twisting and turning quickly before
                                    splashing into the water. Breaking each dive into simple
                                    elements not only makes performing each dive easier but also
