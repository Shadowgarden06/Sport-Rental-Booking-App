...
function Players(props) {
    ...
    const { tennisPlayers } = props;

    return (
        <div>
            <div className=' bg-player5'>
                <div className='text-black box-player ms-8 pt-6'>
                    <span className='fs-48 text-uppercase'>
                        Player <span className='fw-bold text-green'>Testimonials</span>
                    </span>
                    <div>
                        ...
                        {tennisPlayers.map((item, index) => {
                            return (
                                <div className='d-flex mt-5 ms-6' key={index}>
                                    ...
                                    <div className='ms-5 text-black box-player-des'>
                                        <h2>
