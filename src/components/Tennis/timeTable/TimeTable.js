...
function TimeTable(props) {
    return (
        <div className='parallax-content22'>
            <div className='timetable2'>
                <div className='d-flex justify-content-between timetable-box2'>
                    <div className='timetable-box3 ms-4'>
                        <span className='d-block fs-5 text-uppercase text-start'>
                            From the Club
                        </span>
                        <span className='fs-65 text-uppercase text-start d-block'>
                            Club <span className='text-green fw-bold'>TimeTable</span>
                        </span>
                    ...
                    <div className='d-flex justify-content-between btn-timtable2 me-4'>
                        <button className='btn text-green bg-transparent border-green text-uppercase'>
                            Learn More
                        </button>
                        <button className='btn btn-green text-white bg-green ms-5 text-uppercase'>
                            Our Location
                        </button>
                    </div>
                </div>
                ...
                <div>
                    <div className='d-flex'>
                        <div className='p-3'>
                            <div className='d-flex fs-13 bg-green justify-content-around text-white p-2 rounded-top-2 text-uppercase'>
                                <div className='border-end border-white fw-bold pe-3'>
                                    Senior team
                                </div>
                                <div className='ps-3'>Main Court</div>
                            </div>
                            ...
                            <div className='bg-white rounded-bottom'>
                                ...
                                <div className='d-flex justify-content-between p-2 border-bottom fs-13'>
                                    ...
                                    <div>
                                        <span className='d-block'>10AM - 11AM</span>
                        ...
                        <div className='p-3'>
                            ...
                            <div className='bg-white rounded-bottom'>
                                ...
                                <div className='d-flex justify-content-between p-2 border-bottom fs-13'>
                                    ...
                                    <div>
                                        <span className='d-block'>06PM - 08PM</span>
                                        <span className='d-block fs-10 text-end'>GYM</span>
                                    </div>
                                </div>
