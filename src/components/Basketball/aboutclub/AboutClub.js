...
function AboutClub(props) {
    return (
        <div className='z-1 d-grid bg-light position-absolute bottom-2 rp-shadow rounded-end-4 text-black'>
            <div className='row'>
                <div className='col p-8 '>
                    <div className='w-580'>
                        ...
                        <div className='d-flex text-start'>
                            <button className='btn bg-redbasket fs-10 about-btn fw-bold text-uppercase me-4 p-2 border-redbasket text-white'>
                                Join The Club
                            </button>
