                ...
                <div className='p-3 rounded-top-2'>
                    ...
                    <div className='bg-white p-3 rounded-bottom-2'>
                        <ul className='text-start ps-0'>
                            ...
                            <span className='text-uppercase fs-10 ps-3'>BasketBall</span>
                        </ul>
                        <span className='d-block fw-bold text-uppercase fs-6 text-start mb-3'>
                            The best MVP players in Ryan Basketball club
                        </span>
                ...
                <div className='p-3 rounded-top-2'>
                    ...
                    <div className='bg-white p-3 rounded-bottom-2'>
                        <ul className='text-start ps-0'>
                            ...
                            <span className='text-uppercase fs-10 ps-3'>Position</span>
                        </ul>
                        <span className='d-block fw-bold text-uppercase fs-6 text-start mb-3'>
                            List of all body positions and elements in basketball
                        </span>
                        <div className='fs-13 text-start'>
                            DCapitalize on low hanging fruit to identify a ballpark value added
                ...
                <div className='p-3 rounded-top-2'>
                    ...
                    <div className='bg-white p-3 rounded-bottom-2'>
                        <ul className='text-start ps-0'>
                            ...
                            <span className='text-uppercase fs-10 ps-3'>Coaches</span>
                        </ul>
                        <span className='d-block fw-bold text-uppercase fs-6 text-start mb-3'>
                            Street basketball is as much fun as the classic one
                        </span>
                        <div className='fs-13 text-start'>
                            Discerning the various types seems difficult to the untrained eye with
                            the divers twisting and turning quickly before splashing into the water.
                            Breaking each dive into simple elements not only makes performing each
                            dive easier but also enhances your experience.
                        </div>
                    </div>
                </div>
                ...
                <div className='p-3 rounded-top-2'>
                    ...
                    <div className='bg-white p-3 rounded-bottom-2'>
                        <ul className='text-start ps-0'>
                            ...
                            <span className='text-uppercase fs-10 ps-3'>Trade</span>
                        </ul>
                        <span className='d-block fw-bold text-uppercase fs-6 text-start mb-3'>
                            Ryan Sport Club historic triumphs in 90’s
                        </span>
                        <div className='fs-13 text-start'>
                            Batting average base passed ball wild pitch second base home leather.
