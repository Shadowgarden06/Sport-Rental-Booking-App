...
function GameReport(props) {
    return (
        <div className='d-flex justify-content-center align-items-center position-absolute top-30 left-10'>
            <div className=' z-1 basketball-rp bg-light  rp-shadow rounded-4 me-5'>
                <div className='row'>
