...
function TimeTable(props) {
    return (
        <div className='parallax14' id='parallax14'>
            <div className='parallax-bg14'></div>
            <div className='parallax-content14'>
                <div className='d-flex justify-content-around'>
                    <div className='timetable-box'>
                        <div className=''>
                            ...
                            <span className='fs-65 text-uppercase text-start d-block'>
                                Club <span className='text-baseball fw-bold'>TimeTable</span>
                            </span>
                        </div>
                    ...
                    <div>
                        <div className='d-flex'>
                            <div className='p-3'>
                                <div className='d-flex fs-13 bg-baseball justify-content-around text-white p-2 rounded-top-2 text-uppercase'>
