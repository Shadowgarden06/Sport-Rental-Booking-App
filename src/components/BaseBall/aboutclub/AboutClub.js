        ...
        <div className='d-grid bg-light position-absolute bottom-baseball rp-shadow rounded-end-4 text-black'>
            <div className='row'>
                <div className='col p-8 '>
                    <div className='w-580'>
                        ...
                        <span className='d-block text-start text-uppercase fs-60 my-3'>
                            About <span className='text-baseball fw-bold'>Ryan</span>
                        </span>
                        <div className='text-start fs-5 mb-3'>
                            The Club provides children the opportunity to learn and develop baseball
                            skills.
                        </div>
                ...
                <div className='col p-0'>
                    <img
                        src='https://oxigeno.bold-themes.com/baseball/wp-content/uploads/sites/7/2017/11/inner-vertical.jpg'
                        alt='final'
